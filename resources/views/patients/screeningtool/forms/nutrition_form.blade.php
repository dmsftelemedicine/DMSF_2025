<form id="nutrition-form">
    ...
    <label class="form-label">1. (Fruits) On average, how many servings of fruit (not including juice) do you eat per day?</label>
	    <div>
	        <label><input type="radio" name="fruit" value="0"> &lt;1</label>&nbsp;&nbsp;
	        <label><input type="radio" name="fruit" value="1"> 1</label>&nbsp;&nbsp;
	        <label><input type="radio" name="fruit" value="2"> 2</label>&nbsp;&nbsp;
	        <label><input type="radio" name="fruit" value="3"> 3</label>&nbsp;&nbsp;
	        <label><input type="radio" name="fruit" value="4"> 4</label>&nbsp;&nbsp;
	        <label><input type="radio" name="fruit" value="5"> 5</label>&nbsp;&nbsp;
	        <label><input type="radio" name="fruit" value="6"> &gt;6</label>&nbsp;&nbsp;
	...
	<div class="mb-3">
	    ...
	    <div>
	        <label><input type="radio" name="fruit_juice" value="0"> &lt;1</label>&nbsp;&nbsp;
	        <label><input type="radio" name="fruit_juice" value="1"> 1</label>&nbsp;&nbsp;
	        <label><input type="radio" name="fruit_juice" value="2"> 2</label>&nbsp;&nbsp;
	        <label><input type="radio" name="fruit_juice" value="3"> 3</label>&nbsp;&nbsp;
	        <label><input type="radio" name="fruit_juice" value="4"> 4</label>&nbsp;&nbsp;
	        <label><input type="radio" name="fruit_juice" value="5"> 5</label>&nbsp;&nbsp;
	        <label><input type="radio" name="fruit_juice" value="6"> &gt;6</label>&nbsp;&nbsp;
	...
	<div class="mb-3">
	    ...
	    <div>
	        <label><input type="radio" name="vegetables" value="0"> &lt;1</label>&nbsp;&nbsp;
	        <label><input type="radio" name="vegetables" value="1"> 1</label>&nbsp;&nbsp;
	        <label><input type="radio" name="vegetables" value="2"> 2</label>&nbsp;&nbsp;
	        <label><input type="radio" name="vegetables" value="3"> 3</label>&nbsp;&nbsp;
	        <label><input type="radio" name="vegetables" value="4"> 4</label>&nbsp;&nbsp;
	        <label><input type="radio" name="vegetables" value="5"> 5</label>&nbsp;&nbsp;
	        <label><input type="radio" name="vegetables" value="6"> &gt;6</label>&nbsp;&nbsp;
	...
	<div class="mb-3">
	    ...
	    <div>
	        <label><input type="radio" name="green_vegetables" value="0"> &lt;1</label>&nbsp;&nbsp;
	        <label><input type="radio" name="green_vegetables" value="1"> 1</label>&nbsp;&nbsp;
	        <label><input type="radio" name="green_vegetables" value="2"> 2</label>&nbsp;&nbsp;
	        <label><input type="radio" name="green_vegetables" value="3"> 3</label>&nbsp;&nbsp;
	        <label><input type="radio" name="green_vegetables" value="4"> 4</label>&nbsp;&nbsp;
	        <label><input type="radio" name="green_vegetables" value="5"> 5</label>&nbsp;&nbsp;
	        <label><input type="radio" name="green_vegetables" value="6"> &gt;6</label>&nbsp;&nbsp;
	...
	<div class="mb-3">
	    ...
	    <div>
	        <label><input type="radio" name="starchy_vegetables" value="0"> &lt;1</label>&nbsp;&nbsp;
	        <label><input type="radio" name="starchy_vegetables" value="1"> 1</label>&nbsp;&nbsp;
	        <label><input type="radio" name="starchy_vegetables" value="2"> 2</label>&nbsp;&nbsp;
	        <label><input type="radio" name="starchy_vegetables" value="3"> 3</label>&nbsp;&nbsp;
	        <label><input type="radio" name="starchy_vegetables" value="4"> 4</label>&nbsp;&nbsp;
	        <label><input type="radio" name="starchy_vegetables" value="5"> 5</label>&nbsp;&nbsp;
	        <label><input type="radio" name="starchy_vegetables" value="6"> &gt;6</label>&nbsp;&nbsp;
	...
	<div class="mb-3">
	    ...
	    <div>
	        <label><input type="radio" name="grains" value="0"> &lt;1</label>&nbsp;&nbsp;
	        <label><input type="radio" name="grains" value="1"> 1</label>&nbsp;&nbsp;
	        <label><input type="radio" name="grains" value="2"> 2</label>&nbsp;&nbsp;
	        <label><input type="radio" name="grains" value="3"> 3</label>&nbsp;&nbsp;
	        <label><input type="radio" name="grains" value="4"> 4</label>&nbsp;&nbsp;
	        <label><input type="radio" name="grains" value="5"> 5</label>&nbsp;&nbsp;
	        <label><input type="radio" name="grains" value="6"> &gt;6</label>&nbsp;&nbsp;
	...
	<div class="mb-3" id="grains2-question" style="display: none;">
	    ...
	    <div>
	        ...
	        <label><input type="radio" name="grains_frequency" value="na"> Choose Not to Answer</label>
	    </div>
	</div>
	<div class="mb-3">
	    <label class="form-label">8. (Whole Grains) On average, how many servings of whole grains do you eat per day?</label>
	    <div>
	        <label><input type="radio" name="whole_grains" value="0"> &lt;1</label>&nbsp;&nbsp;
	        <label><input type="radio" name="whole_grains" value="1"> 1</label>&nbsp;&nbsp;
	        <label><input type="radio" name="whole_grains" value="2"> 2</label>&nbsp;&nbsp;
	        <label><input type="radio" name="whole_grains" value="3"> 3</label>&nbsp;&nbsp;
	        <label><input type="radio" name="whole_grains" value="4"> 4</label>&nbsp;&nbsp;
	        <label><input type="radio" name="whole_grains" value="5"> 5</label>&nbsp;&nbsp;
	        <label><input type="radio" name="whole_grains" value="6"> &gt;6</label>&nbsp;&nbsp;
	...
	<div class="mb-3" id="whole-grains2-question" style="display: none;">
	    ...
	    <div>
	        ...
	        <label><input type="radio" name="whole_grains_frequency" value="na"> Choose Not to Answer</label>
	    </div>
	</div>
	<div class="mb-3">
	    <label class="form-label">10. (Milk) On average, how many servings of milk do you eat or drink per day?</label>
	    <div>
	        <label><input type="radio" name="milk" value="0"> &lt;1</label>&nbsp;&nbsp;
	        <label><input type="radio" name="milk" value="1"> 1</label>&nbsp;&nbsp;
	        <label><input type="radio" name="milk" value="2"> 2</label>&nbsp;&nbsp;
	        <label><input type="radio" name="milk" value="3"> 3</label>&nbsp;&nbsp;
	        <label><input type="radio" name="milk" value="4"> 4</label>&nbsp;&nbsp;
	        <label><input type="radio" name="milk" value="5"> 5</label>&nbsp;&nbsp;
	        <label><input type="radio" name="milk" value="6"> &gt;6</label>&nbsp;&nbsp;
	...
	<div class="mb-3" id="milk2-question" style="display: none;">
	    ...
	    <div>
	        ...
	        <label><input type="radio" name="milk_frequency" value="na"> Choose Not to Answer</label>
	    </div>
	</div>
	<div class="mb-3">
	    <label class="form-label">12. (Low-Fat Milk) On average, how many servings of low-fat milk products do you eat per day?</label>
	    <div>
	        <label><input type="radio" name="low_fat_milk" value="0"> &lt;1</label>&nbsp;&nbsp;
	        <label><input type="radio" name="low_fat_milk" value="1"> 1</label>&nbsp;&nbsp;
	        <label><input type="radio" name="low_fat_milk" value="2"> 2</label>&nbsp;&nbsp;
	        <label><input type="radio" name="low_fat_milk" value="3"> 3</label>&nbsp;&nbsp;
	        <label><input type="radio" name="low_fat_milk" value="4"> 4</label>&nbsp;&nbsp;
	        <label><input type="radio" name="low_fat_milk" value="5"> 5</label>&nbsp;&nbsp;
	        <label><input type="radio" name="low_fat_milk" value="6"> &gt;6</label>&nbsp;&nbsp;
	...
	<div class="mb-3" id="low-fat-milk2-question" style="display: none;">
	    ...
	    <div>
	        ...
	        <label><input type="radio" name="low_fat_milk_frequency" value="na"> Choose Not to Answer</label>
	    </div>
	</div>
	<div class="mb-3">
	    <label class="form-label">14. (Beans) On average, how many servings of beans (legumes) do you eat per day?</label>
	    <div>
	        <label><input type="radio" name="beans" value="0"> &lt;1</label>&nbsp;&nbsp;
	        <label><input type="radio" name="beans" value="1"> 1</label>&nbsp;&nbsp;
	        <label><input type="radio" name="beans" value="2"> 2</label>&nbsp;&nbsp;
	        <label><input type="radio" name="beans" value="3"> 3</label>&nbsp;&nbsp;
	        <label><input type="radio" name="beans" value="4"> 4</label>&nbsp;&nbsp;
	        <label><input type="radio" name="beans" value="5"> 5</label>&nbsp;&nbsp;
	        <label><input type="radio" name="beans" value="6"> &gt;6</label>&nbsp;&nbsp;
	...
	<div class="mb-3">
	    ...
	    <div>
	        <label><input type="radio" name="nuts_seeds" value="0"> &lt;1</label>&nbsp;&nbsp;
	        <label><input type="radio" name="nuts_seeds" value="1"> 1</label>&nbsp;&nbsp;
	        <label><input type="radio" name="nuts_seeds" value="2"> 2</label>&nbsp;&nbsp;
	        <label><input type="radio" name="nuts_seeds" value="3"> 3</label>&nbsp;&nbsp;
	        <label><input type="radio" name="nuts_seeds" value="4"> 4</label>&nbsp;&nbsp;
	        <label><input type="radio" name="nuts_seeds" value="5"> 5</label>&nbsp;&nbsp;
	        <label><input type="radio" name="nuts_seeds" value="6"> &gt;6</label>&nbsp;&nbsp;
	...
	<div class="mb-3">
	    ...
	    <div>
	        <label><input type="radio" name="seafood" value="0"> &lt;1</label>&nbsp;&nbsp;
	        <label><input type="radio" name="seafood" value="1"> 1</label>&nbsp;&nbsp;
	        <label><input type="radio" name="seafood" value="2"> 2</label>&nbsp;&nbsp;
	        <label><input type="radio" name="seafood" value="3"> 3</label>&nbsp;&nbsp;
	        <label><input type="radio" name="seafood" value="4"> 4</label>&nbsp;&nbsp;
	        <label><input type="radio" name="seafood" value="5"> 5</label>&nbsp;&nbsp;
	        <label><input type="radio" name="seafood" value="6"> &gt;6</label>&nbsp;&nbsp;
	...
	<div class="mb-3" id="seafood2-question" style="display: none;">
	    ...
	    <div>
	        ...
	        <label><input type="radio" name="seafood_frequency" value="na"> Choose Not to Answer</label>
	    </div>
	</div>
	<div class="mb-3">
	    <label class="form-label">18. (SSB) On average, how many sugar-sweetened beverages do you drink per day?</label>
	    <div>
	        <label><input type="radio" name="ssb" value="0"> &lt;1</label>&nbsp;&nbsp;
	        <label><input type="radio" name="ssb" value="1"> 1</label>&nbsp;&nbsp;
	        <label><input type="radio" name="ssb" value="2"> 2</label>&nbsp;&nbsp;
	        <label><input type="radio" name="ssb" value="3"> 3</label>&nbsp;&nbsp;
	        <label><input type="radio" name="ssb" value="4"> 4</label>&nbsp;&nbsp;
	        <label><input type="radio" name="ssb" value="5"> 5</label>&nbsp;&nbsp;
	        <label><input type="radio" name="ssb" value="6"> &gt;6</label>&nbsp;&nbsp;
	...
	<div class="mb-3" id="ssb2-question" style="display: none;">
	    ...
	    <div>
	        ...
	        <label><input type="radio" name="ssb_frequency" value="na"> Choose Not to Answer</label>
	    </div>
	</div>
	<div class="mb-3">
