<x-app-layout>
    ...
    <style>
        ...
        .content-wrapper {
            ...
            /* Light semi-transparent container */
            border-radius: 10px;
            padding: 2rem;
        }
        ...
        .dataTables_wrapper {
            min-height: 500px;
            /* Set minimum height for table wrapper */
        }

        #patientsTable_wrapper .dataTables_scrollBody {
            min-height: 400px;
            /* Set minimum height for table body */
        }
        ...
        .dataTables_filter input:focus {
            ...
            box-shadow: 0 0 0 0.2rem rgba(124, 173, 62, 0.25) !important;
            outline: 0 !important;
        }
    ...
    <div class="bg-falls pt-20 pb-20">
            ...
            <table id="patientsTable" class="table table-bordered table-hover bg-white text-dark">
                <thead class="thead-light">
                    <tr>
                        ...
                        <th width="32%">Diabetes Status</th>
    ...
    <script>
        $(document).ready(function() {
            $('#patientsTable').DataTable({
                ...
                order: [
                    [5, 'desc']
                ], // Sort by Created column (index 5) in descending order (most recent first)
                columnDefs: [{
                        targets: 0, // Number column
                        orderable: false, // Disable sorting on number column
                        searchable: false
                    },
                    {
                ...
                drawCallback: function() {
                    // Re-number rows after search/sort
                    var api = this.api();
                    api.column(0, {
                        search: 'applied',
                        order: 'applied'
