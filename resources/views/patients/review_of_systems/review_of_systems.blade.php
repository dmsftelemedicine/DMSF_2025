                                                        ...
                                                        <div class="col-md-4 mb-3">
                                                            <div class="card h-100">
                                                                ...
                                                                <div class="card-body py-2 position-relative" style="z-index: 1;">
                                                                    <img src="{{ asset('assets/icons/' . $icon) }}" alt="{{ $section }} icon" class="position-absolute end-0 bottom-0 me-2 mb-2" style="width: 100px; opacity: 0.2; pointer-events: none; z-index: 0;">
                                                                    <div style="position: relative; z-index: 1;">
                                                                        @foreach($symptoms as $symptom)
                                                                            ...
                                                                            <div class="form-check mb-1">
                                                                                <input class="form-check-input" type="checkbox" name="symptoms[{{ $sectionKey }}][]" value="{{ $symptom }}" id="{{ $inputId }}">
                                                    ...
                                                    <form id="reviewOfSystemsForm">
                                                        ...
                                                        <div class="row">
                                                            @foreach($sections as $section => $symptoms)
                                                                ...
                                                                @endphp
                                                                <div class="form-check mb-1">
                                                                    <input class="form-check-input ros-symptom-checkbox" type="checkbox" name="symptoms[{{ $sectionKey }}][]" value="{{ $symptom }}" id="{{ $inputId }}">
                                                                    <label class="form-check-label small" for="{{ $inputId }}">
                                                                        {{ ucfirst($symptom) }}
                                                                    </label>
                                                                </div>
