...
Route::middleware('auth')->group(function () {
    ...
    // View Patient Screenings and Assessments - now handled by ConsultationController
    Route::get('/patients/{patient}/screenings/{consultation?}/{tab?}', [ConsultationController::class, 'show'])->name('patients.screenings');
